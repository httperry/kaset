...
struct ExtensionsTests {
    ...
    @Test("Upgrades URL to ultra high quality 1200px")
    func ultraHighQualityThumbnail() throws {
        let url = try #require(URL(string: "https://lh3.googleusercontent.com/abc=w120-h120-l90-rj"))
        let ultraQuality = url.ultraHighQualityThumbnailURL
        #expect(ultraQuality != nil)
        #expect(try #require(ultraQuality?.absoluteString.contains("w1200-h1200")))
    }
